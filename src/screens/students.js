...
function Students(){
  ...
  //create data
    ...
    const [idate, setDate] = React.useState(false);
        ...
        <div className="flex h-screen">
            ...
            <div>
                ...
                <div className="flex bg-transparent">
                    ...
                    <div className="ml-80 mt-8 pl-96"><svg width="14" height="22" viewBox="0 0 14 22" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<rect width="14" height="22" fill="white"/>
                ...
                <ReactModal isOpen = {modalOpen} style={customStyles}>
                    ...
                    <div className="px-3">
                        ...
                        <input id="phone" onChange={(e)=>setPhone(e.target.value)} className="border pr-32 h-12 w-80 rounded-sm border-gray-300 placeholder: text-sm placeholder:text-gray-300" type="number" placeholder="Phone"></input>
                    </div>
                    ...
                    <div className="px-3">
                        ...
                        <button className="border m-3 px-28 py-2 bg-yellow-500 text-white rounded-sm border-yellow-500" 
                         onClick={createPost} type="submit"> Add Student</button> 
                    </div>
                </ReactModal>
                </div><br/>
